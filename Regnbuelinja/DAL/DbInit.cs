    ...
    public class DbInit
    {
        public static void Initialize(IApplicationBuilder app)
        {
            using (var serviceScope = app.ApplicationServices.CreateScope())
            {
                ...
                var ferd1 = new Ferd { Båt = båt1, Rute = rute1, AvreiseTid = new DateTime(2021, 12, 1, 14, 0, 0) , AnkomstTid = new DateTime(2021, 12, 2, 9, 0, 0)};

                //avreisedatoer for rute1
                for (int i = 2; i < 31; i++)
                {
                    context.Ferder.Add(new Ferd { Båt = båt1, Rute = rute1, AvreiseTid = new DateTime(2021, 12, i, 14, 0, 0), AnkomstTid = new DateTime(2021, 12, i+1, 9, 0, 0) });
                }

                //avreisedatoer for rute2
                for (int i = 1; i < 31; i++)
                {
                    context.Ferder.Add(new Ferd { Båt = båt1, Rute = rute2, AvreiseTid = new DateTime(2021, 12, i, 11, 0, 0), AnkomstTid = new DateTime(2021, 12, i+1, 6, 0, 0) });
                }
                ...
                for (int i = 1; i < 30; i++)
                {
                    ...
                    context.Ferder.Add(new Ferd { Båt = båt2, Rute = rute3, AvreiseTid = new DateTime(2021, 12, i, 16, 0, 0), AnkomstTid = new DateTime(2021, 12, i+2, 10, 0, 0)});
                }

                //avreisedatoer for rute 4
                for (int i = 1; i < 30; i++)
                {
                    context.Ferder.Add(new Ferd { Båt = båt2, Rute = rute3, AvreiseTid = new DateTime(2021, 12, i, 20, 0, 0), AnkomstTid = new DateTime(2021, 12, i+2, 14, 0, 0)});
                }
